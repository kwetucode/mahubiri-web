...
class UpdatePreacherProfileRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'ministry_name' => 'sometimes|required|string|max:255',
            'ministry_type' => ['sometimes', 'required', Rule::in(MinistryType::getMinistryValues())],
            'avatar_url' => [
                'nullable',
