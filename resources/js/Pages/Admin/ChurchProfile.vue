            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
                ...
                <div class="lg:col-span-2">
                    <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200/60 dark:border-gray-700 shadow-sm overflow-hidden">
                        ...
                        <div class="relative">
                            <!-- Gradient strip -->
                            <div class="h-24 bg-linear-to-r from-primary/80 via-primary/60 to-primary/30 relative overflow-hidden">
                                <!-- Decorative pattern -->
                                ...
                                <div class="absolute top-3 right-4 z-10">
                                    <button
                                        v-if="!editing"
                                        @click="startEditing"
                                        class="inline-flex items-center gap-1.5 px-3.5 py-2 bg-white/20 backdrop-blur-sm text-white rounded-xl text-xs font-semibold hover:bg-white/30 transition-colors border border-white/20"
                                    >
