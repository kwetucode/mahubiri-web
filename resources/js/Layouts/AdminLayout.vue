...
<template>
    <div class="min-h-screen bg-gray-50/50">
        ...
        <!-- Sidebar -->
        <aside
            class="fixed inset-y-0 left-0 z-50 flex flex-col bg-white border-r border-gray-200/80 transition-all duration-300 ease-in-out"
            :class="[
        ...
        >
            ...
            <div class="flex items-center gap-3 px-5 py-5 border-b border-gray-100 min-h-[72px]">
                ...
                >
                    <div v-show="!sidebarCollapsed" class="min-w-0">
                        <h1 class="text-lg font-bold text-gray-900 truncate">Mahubiri</h1>
            ...
            <div class="hidden lg:block px-3 py-2 border-t border-gray-100">
                <button
                    @click="toggleSidebar"
                    class="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-gray-400 hover:bg-gray-100 hover:text-gray-600 transition-all duration-200"
                ...
                <div class="flex items-center justify-between px-4 sm:px-6 lg:px-8 h-[72px]">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-400 hidden sm:block capitalize">{{ currentDate }}</p>
                        </div>
                    </div>

                    <div class="flex items-center gap-3">
                        <!-- Search (decorative) -->
                        <div class="hidden md:flex items-center gap-2 px-4 py-2 bg-gray-100/80 rounded-xl text-gray-400 text-sm min-w-[200px]">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                            </svg>
                            <span>Rechercher...</span>
                            <kbd class="ml-auto px-1.5 py-0.5 bg-white rounded text-[10px] font-mono text-gray-400 border border-gray-200">⌘K</kbd>
                        </div>
                        ...
                        <div class="relative" ref="notifDropdownRef">
                            <button
                                ...
                                class="relative p-2.5 rounded-xl text-gray-500 hover:bg-gray-100 hover:text-gray-700 transition-colors"
                            >
                            ...
                            >
                                <div
                                    v-if="notifOpen"
                                    class="absolute right-0 mt-2 w-96 max-h-112 bg-white rounded-2xl shadow-xl border border-gray-200/60 ring-1 ring-black/5 overflow-hidden z-50 flex flex-col"
                                >
                                    <!-- Header -->
