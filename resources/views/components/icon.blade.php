...
$icons = [
    ...
    'church' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />',
    ...
    'toggle-on' => '<path d="M17 8a5 5 0 01-10 0M7 16h10a6 6 0 000-12H7a6 6 0 000 12z" />',
...
$fillIcons = ['heart'];
$strokeType = in_array($name, $fillIcons) ? 'fill' : 'fill="none" stroke';
@endphp

<svg {{ $attributes->merge(['class' => $class]) }} {!! $strokeType !!}="currentColor" viewBox="0 0 24 24">
    {!! $icons[$name] ?? '' !!}
</svg>
